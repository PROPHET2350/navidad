<%@ Page Title="" Language="C#" MasterPageFile="~/template.Master" AutoEventWireup="true" CodeBehind="Demograficos_empleados.aspx.cs" Inherits="Views.Demograficos_empleados" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    Demograficos empleado
</asp:Content>
                        ...
                        <div class="card card-login mx-auto mt-5">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" placeholder="Ubicacion" required autofocus="autofocus" ID="txt_ubicacion" runat="server">
